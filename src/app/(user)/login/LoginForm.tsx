        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={loading}
              className="w-full h-12 flex items-center justify-center gap-2 border-2 border-gray-200 hover:border-gray-300 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group"
            >
              {loading ? (
                <ButtonSpinner />
              ) : (
