...
-- صلاحيات MEDICAL_RECORDS

-- DOCTOR - يقدر يقرأ ويكتب سجلاته فقط
INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (213, 'MEDICALRECORDS', 'CREATE');

INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (213, 'MEDICALRECORDS', 'READ');

INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (213, 'MEDICALRECORDS', 'UPDATE');

-- PATIENT - يقدر يقرأ سجلاته فقط
INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (216, 'MEDICALRECORDS', 'READ');

-- ADMIN - كل الصلاحيات
INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (212, 'MEDICALRECORDS', 'CREATE');

INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (212, 'MEDICALRECORDS', 'READ');

INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (212, 'MEDICALRECORDS', 'UPDATE');

INSERT INTO tah57.ROLE_PERMISSIONS (ROLE_ID, SUBJECT, ACTION) 
VALUES (212, 'MEDICALRECORDS', 'DELETE');
